...
class MyAgent(AlphaBetaAgent):
    ...
    def __get_best_action(self, state: PontuState, start_successor: Union[Successor, None]) -> tuple:
        ...
        while same_counter < 6 and time_needed_for_next_depth < self.game_time - elapsed_time:
            self.max_depth += 1
